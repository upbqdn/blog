...
The theme handles: Tailwind CSS v4 pipeline, dark mode (system `prefers-color-scheme`), self-hosted MathJax 4 with Pagella Math, Pagefind search UI, Remark42 comments, EB Garamond + Iosevka fonts, Schema.org microdata.
